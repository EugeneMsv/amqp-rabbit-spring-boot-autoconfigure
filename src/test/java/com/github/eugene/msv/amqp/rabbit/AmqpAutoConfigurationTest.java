...
import com.github.eugene.msv.amqp.rabbit.bean.AmqpBeansFactory;
import com.github.eugene.msv.amqp.rabbit.bean.DefaultAmqpBeanDefinitionCustomizer;
import com.github.eugene.msv.amqp.rabbit.properties.AmqpConnectionProperties;
...
import static com.github.eugene.msv.amqp.rabbit.AmqpAutoConfigurationConstants.Property.BEAN_DEFINITION_CUSTOMIZER;
import static com.github.eugene.msv.amqp.rabbit.AmqpAutoConfigurationConstants.Property.FACTORY_BEAN_NAME;
import static com.github.eugene.msv.amqp.rabbit.AmqpAutoConfigurationConstants.Queue.*;
import static com.github.eugene.msv.amqp.rabbit.bean.AmqpBeanNameResolver.*;
    ...
    public void test_customAmqpBeanDefinitionCustomizer() {
        ...
        contextWrapper
                .withConfiguration(MessageConverterConfiguration.class,
                        AmqpAutoConfiguration.class)
                .withEnvironment(
                        BEAN_DEFINITION_CUSTOMIZER + ":" + "com.github.eugene.msv.amqp.rabbit.AmqpAutoConfigurationTest$TestAmqpBeanDefinitionCustomizer",
                        "queue.management.configurations.local.connection-prefix:local.jms",
                        "local.jms.host:fakeHost",
                        "local.jms.port:123",
                        "local.jms.user:fakeUser",

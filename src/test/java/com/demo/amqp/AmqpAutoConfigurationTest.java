...
public class AmqpAutoConfigurationTest {
    ...
    private void assertConnectionBeans(String connectionName) {
        ...
        SimpleRabbitListenerContainerFactory listenerContainerFactory = context.getBean(
                getRabbitListenerContainerFactoryBeanName(connectionName), SimpleRabbitListenerContainerFactory.class);
    ...
    public void test_oneSimpleQueue() {
        ...
        Queue localQueue = context.getBean(getQueueBeanName(namePrefix, "doc-request"), Queue.class);
    ...
    public void test_simpleQueuesInOneRabbit() {
        ...
        Queue localDocRequestQueue = context.getBean(getQueueBeanName(namePrefix, "doc-request"), Queue.class);
    ...
    public void test_ManyConnections_WithComplexQueues() {
        ...
        Queue deadLetterQueue1 = context.getBean(getDeadLetterQueueBeanName(namePrefix1, "fake-queue"), Queue.class);
        ...
        assertEquals(ARGUMENT_VALUE_DEAD_LETTER_EXCHANGE, arguments1.get(ARGUMENT_KEY_DEAD_LETTER_EXCHANGE));
        ...
        assertEquals(ARGUMENT_VALUE_DEAD_LETTER_EXCHANGE, arguments2.get(ARGUMENT_KEY_DEAD_LETTER_EXCHANGE));
        ...
        assertEquals(ARGUMENT_VALUE_DEAD_LETTER_EXCHANGE,
        ...
        Queue queueForBinding1 = context.getBean(getQueueBeanName(namePrefix3, "queueForBinding1"), Queue.class);

        TopicExchange topicExchangeForBinding1 = context.getBean(
                getTopicExchangeBeanName(namePrefix3, "topicExchangeForBinding1"), TopicExchange.class);
        Binding queueForBinding1topicExchangeForBinding1rk1 = context.getBean(
                getBindingBeanName(namePrefix3, "queueForBinding1", "topicExchangeForBinding1", "rk1"), Binding.class);
        Binding queueForBinding1topicExchangeForBinding1rk2 = context.getBean(
                getBindingBeanName(namePrefix3, "queueForBinding1", "topicExchangeForBinding1", "rk2"), Binding.class);
    ...
    public void test_containerListenerProperties() throws NoSuchFieldException, IllegalAccessException {
        ...
        SimpleRabbitListenerContainerFactory rabbitListenerContainerFactory = context.getBean(
                getRabbitListenerContainerFactoryBeanName(namePrefix), SimpleRabbitListenerContainerFactory.class);
